    ...
    private void throwIfShapeIsIncompatible(Object obj) {
        if (isBuffer(obj)) {
            ...
            if (numBytes != capacity) {
                throw new IllegalArgumentException(String.format("Cannot convert between a TensorFlowLite buffer with %d bytes and a Java Buffer with %d bytes.", new Object[]{Integer.valueOf(numBytes), Integer.valueOf(capacity)}));
            }
            return;
        }
        int[] computeShapeOf = computeShapeOf(obj);
